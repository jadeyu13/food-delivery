    ...
    <div className="w-full min-h-screen h-auto flex items-center justify-center">
      <div className="w-[90%] md:w-[75%] border border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4">
              ...
              {!imageAsset ? (
                ...
                <>
                  <div className="relative h-full">
                    ...
                    <button
                      type="button"
                      className="absolute bottom-3 right-2 p-3 rounded-full bg-red-500 text-xl cursor-pointer outline-none hover:shadow-md duration-100 transition-all ease-in-out"
                      onClick={deleteImage}
                    >
        ...
        <div className="w-full flex flex-col md:flex-row items-center gap-3">
          ...
          <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2">
            <RiMoneyDollarBoxFill className="text-gray-700 text-2xl" />
            <input
              type="number"
              required
              value={price}
        ...
        <div className="w-full flex items-center">
          <button
            type="button"
            className="ml-0 md:ml-auto w-full md:w-auto border-none outline-none bg-lime-500 px-12 py-2 rounded-lg text-lg text-white"
            onClick={saveDetails}
          >
            Save
          </button>
